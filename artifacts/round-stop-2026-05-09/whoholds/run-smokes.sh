...
# Run from repo root: bash artifacts/round-stop-2026-05-09/whoholds/run-smokes.sh
...
set +e
BIN="$(pwd)/artifacts/round-stop-2026-05-09/whoholds/fresh-publish/whoholds.exe"
OUT="$(pwd)/artifacts/round-stop-2026-05-09/whoholds/out"
DATA="$(pwd)/artifacts/round-stop-2026-05-09/whoholds/data"
mkdir -p "$OUT" "$DATA"
