...
# Run from repo root: bash artifacts/reverify-2026-05-06/clip/run-smokes.sh
...
set +e
BIN="$(pwd)/artifacts/reverify-2026-05-06/clip/bin/clip.exe"
OUT="$(pwd)/artifacts/reverify-2026-05-06/clip/out"
DATA="$(pwd)/artifacts/reverify-2026-05-06/clip/data"
mkdir -p "$OUT" "$DATA"
