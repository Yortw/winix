...
# Run from repo root: bash artifacts/reverify-2026-05-06/treex/run-smokes.sh
...
set +e
BIN="$(pwd)/artifacts/reverify-2026-05-06/treex/bin/treex.exe"
OUT="$(pwd)/artifacts/reverify-2026-05-06/treex/out"
DATA="$(pwd)/artifacts/reverify-2026-05-06/treex/data"
mkdir -p "$OUT" "$DATA"
