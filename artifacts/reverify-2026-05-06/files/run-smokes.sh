...
# Run from repo root: bash artifacts/reverify-2026-05-06/files/run-smokes.sh
# Reuses treex's fixture-tree shape (deterministic against ./data/fixture).

set +e
BIN="$(pwd)/artifacts/reverify-2026-05-06/files/bin/files.exe"
OUT="$(pwd)/artifacts/reverify-2026-05-06/files/out"
DATA="$(pwd)/artifacts/reverify-2026-05-06/files/data"
mkdir -p "$OUT" "$DATA"
